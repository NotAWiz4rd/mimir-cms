...
/**
 * This class be initiated by {@link WebSecurityConfig} and will create a custom {@link UserDetails}
 * objects containing additional user information (like surname, mail) and the default {@link
 * LdapUserDetails}. Taken from: https://stackoverflow.com/a/30983147
 * https://stackoverflow.com/q/37728277
 */
@Configuration
public class OwnUserDetailsContextMapper extends LdapUserDetailsMapper implements
    UserDetailsContextMapper {

  /**
   * If the user can be authenticated and Spring Security wants to create a userDetails objects with
   * some LDAP attribute, this class intercepts and return our custom {@link OwnUserDetails}
   * containing more LDAP attributes and the {@link LdapUserDetails} object itself. return
   */
  @Override
  public UserDetails mapUserFromContext(DirContextOperations ctx, String username,
      Collection<? extends GrantedAuthority> authorities) {
    LdapUserDetails userDetails = (LdapUserDetails) super
        .mapUserFromContext(ctx, username, authorities);
