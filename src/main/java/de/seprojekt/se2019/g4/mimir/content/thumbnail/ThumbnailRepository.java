 ...
 * {@link Thumbnail} in the database and execute CRUD (create, read, update, delete) operation on
 * the database. The name of the methods defines how Spring Data JPA will implement them - e.g.
