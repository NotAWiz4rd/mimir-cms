 ...
 * The 'singleton' will be autowired to constructors, which are requesting the 'singleton'.
 * The name of a environment variables can be written in different ways
 * (https://docs.spring.io/spring-boot/docs/current/reference/html/boot-features-external-config.html):
 * - kebab case (for .properties, .yml files): user.authentication.ldap.user-search-filter
 * - camel case: user.authentication.ldap.userSearchFilter
